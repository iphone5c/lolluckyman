 ...
 */
@RestController
@RequestMapping(value = "/lol/account/jsp")
public class LolAccountControllerJSP extends BaseController {

    public Logger log = Logger.getLogger(LolAccountControllerJSP.class);//日志
