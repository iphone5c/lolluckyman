 ...
 */
Ext.define('LLManBack.business.playrecord.forms.panel12', {
    ...
    initComponent: function () {
        ...
        Ext.apply(me, {
            ...
            items: [
                ...
                { text:data.teamA.chinaName+'('+data.teamA.englishName+')-有',islabel: true},
                {   xtype:'textfield',name: 'oddsA'},
                { },

                { text:data.teamB.chinaName+'('+data.teamB.englishName+')-有',islabel: true},
