 ...
 */
Ext.define('LLManBack.business.playrecord.forms.panel2', {
    ...
    initComponent: function () {
        ...
        Ext.apply(me, {
            ...
            items: [
                ...
                { text:data.teamA.chinaName+'('+data.teamA.englishName+')-胜',islabel: true},
                {   xtype:'textfield',name: 'oddsA'},
                { },

                { text:data.teamB.chinaName+'('+data.teamB.englishName+')-胜',islabel: true},
