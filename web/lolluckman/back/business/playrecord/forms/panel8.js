 ...
 */
Ext.define('LLManBack.business.playrecord.forms.panel8', {
    ...
    initComponent: function () {
        ...
        Ext.apply(me, {
            ...
            items: [
                ...
                { text:data.teamA.chinaName+'('+data.teamA.englishName+')-多',islabel: true},
                {   xtype:'textfield',name: 'oddsA'},
                { },

                { text:data.teamB.chinaName+'('+data.teamB.englishName+')-多',islabel: true},
                {   xtype:'textfield',name: 'oddsB'},
                { },

                { text:'相同',islabel: true},
