 ...
 */
Ext.define('LLManBack.business.prize.prizeList',{
    ...
    initComponent: function () {
        ...
        Ext.applyIf(me, {                             //如果指定对象不存在相同的属性，将配置的属性拷贝到指定对象
                    ...
                    },
                    {
                        ...
                        handler: function () {
                            ...
                            if (list.length != 1)
                                ...
                                me.deletePrize(list[0].data.code);
                        }
                    }
                ]
            },
            columns: [
                ...
                { header: '奖品名称', dataIndex: 'prizeName',width:120 },
                { header: '奖品类型', dataIndex: 'prizeType',width:360 },
                { header: '奖品描述', dataIndex: 'description',width:360 },
    ...
    createStore:function(){
        var store=Ext.create('Ext.data.Store', {
            ...
            fields: [],
            proxy: {
                url: '/back/prize/getPrizePageList',
                type: 'ajax',
     ...
     */
    deletePrize:function(prizeCode){
        var result = Ext.appContext.invokeService("/back/prize","/deletePrize", {prizeCode: prizeCode});
