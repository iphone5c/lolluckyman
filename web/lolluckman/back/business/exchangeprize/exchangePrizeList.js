 ...
 */
Ext.define('LLManBack.business.exchangeprize.exchangePrizeList',{
    ...
    createStore:function(){
        var store=Ext.create('Ext.data.Store', {
            ...
            autoLoad: true,
            pageSize:20,
            exchangePrizeStatus:'未结算',
            proxy: {
                url: '/back/exchangeprize/getExchangePrizePageListForGL',
                type: 'ajax',
                extraParams: {pageIndex:0,pageSize:20,exchangePrizeStatus:'未结算'},
                reader: {
                    type: 'json',
