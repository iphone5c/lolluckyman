...
Ext.define('Ext.rtl.chart.Chart', {
    ...
    initSurfaceCfg: function(cfg) {
        this.callParent(arguments);
        // Even in rtl model, we still want the chart to use ltr, since
    ...
    getEventXY: function(e) {
        ...
        if (this.rtlEvent) {
            // If we're in RTL model, the event coordinates have been reversed,
...
Ext.define('Ext.rtl.draw.Sprite', {
     ...
     * display correctly whether in RTL or LTR model, the RLM affects how other characters
