    ...
    createPicker: function() {
        var me = this,
            picker = new Ext.tree.Panel({
                ...
                store: me.store,
                floating: true,
				rootVisible: false,						// 这个根节点设置在这儿才有效
        ...
        if (Ext.isIE9 && Ext.isStrict) {
            // In IE9 strict model, the tree view grows by the height of the horizontal scroll bar when the items are highlighted or unhighlighted.
